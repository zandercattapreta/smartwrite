...
Active feature backlog. Organized by module and priority.  
...
| # | Feature | Priority | Version |
|---|---|---|---|
| 4.1 | Voice recording | 🟡 Medium | v0.2 |
| 4.2 | Auto-transcription via whisper.cpp (offline) | 🟡 Medium | v0.2 |
| 4.3 | New note creation with transcript | 🟡 Medium | v0.2 |
| 4.4 | Auto language detection (Portuguese-first) | 🟢 Low | v0.2 |
...
> Want to propose a feature? [Open an issue](https://github.com/zandercattapreta/smartwrite/issues).
